...
export default function CursorGrid({
  ...
  useEffect(() => {
    ...
    // Listen on window so the grid still lights up even when a page
    // element sits visually on top of this fixed background layer.
