...
**Who gets these leads**, on every Meta Ads card. Rule under **Distribution**; the owner chose all four defaults when asked — rotate within the chosen group on the lane's own rules, force-accept at the group's floor rather than letting the lead escape, the admin takes their turn on the same terms as everybody else, and manual promotion stays unrestricted.
